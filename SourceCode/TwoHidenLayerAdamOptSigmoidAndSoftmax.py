...
#placeholder
def TwoHidenLayerAdamOptSigmoidAndSoftmaxMtd(DataLength,NumOfIteration):
    ...
    Testacc_Array = []
    acc_Array = []
    print('Two Hidden AdamOpt Layer Traing Started>...............................')
    ...
    print('Two Hidden Layer Traing completed')       
