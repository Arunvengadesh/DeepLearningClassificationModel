...
#placeholder
def TwoHidenLayerAdamOptReluAndSoftmaxMtd(DataLength,NumOfIteration):
    ...
    Testacc_Array = []
    acc_Array = []
    print('Two Hidden Layer Adam Opt RELU and Softmax Traing Started>...............................')
    ...
    for i in range(1,NumOfIteration):
        ...
        c, y,y_,w, b,a,re1, re2 = sess.run([cross_entropy,Y,Y_, W1, B1,accuracy, RELUMAT1, RELUMAT2], feed_dict={X: batch_X, Y_: batch_Y})
        acc_Array.append(a)
    ...
    return acc_Array,Testacc_Array,TrngCrossEntropy,TestCrossEntropy,re1,re2
