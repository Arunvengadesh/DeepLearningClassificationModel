...
#placeholder
def TwoHidenLayerAdamDecayOptReluDropOutAndSoftmaxMtd(DataLength,NumOfIteration):
    ...
    Testacc_Array = []
    acc_Array = []
    print('TwoHidenLayerAdamDecayOptReluDropOutAndSoftmaxMtd Traing Started>...............................')
    ...
    for i in range(1,NumOfIteration):
        ...
        c, y,y_,w, b,a = sess.run([cross_entropy,Y,Y_, W1, B1,accuracy], feed_dict={X: batch_X, Y_: batch_Y, pkeep: 1.0})
        acc_Array.append(a)
        TrngCrossEntropy.append(c)
        #TestAttrGen,TestClasGen = GenerateData(DataLength)
        ct, y,y_,w, b,at = sess.run([cross_entropy,Y,Y_, W1, B1,accuracy], feed_dict={X: mnist.test.images[1:1000,:,:], Y_: mnist.test.labels[1:1000,:], pkeep: 1.0})    
